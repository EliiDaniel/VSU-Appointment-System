            ...
            <div class="mx-auto sm:px-6 lg:px-8 h-full pt-16">
                <div class="bg-white h-full dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-center items-center">
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white text-center">Your email has been successfully verified. You are now ready to proceed with your request.<br><br><span class="text-lg">This page will automatically close in 5 seconds. . .</span></h3>
                    </div>
                </div>
            </div>
        </div>
