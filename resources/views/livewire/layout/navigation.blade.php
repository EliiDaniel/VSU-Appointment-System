                ...
                <x-dropdown align="right" width="56">
                    ...
                    <x-slot name="content">
                        @if(auth()->user()->notifications->isNotEmpty())
                            ...
                            @endforeach
                            <x-dropdown-link :href="request()->routeIs('registrar*') ? route('registrar.notifications') : (request()->routeIs('cashier*') ? route('cashier.notifications') : route('requester.notifications'))" class="flex justify-center uppercase tracking-widest font-semibold text-xs">
                                view all
                            </x-dropdown-link>
                        @else
                            <x-dropdown-link class="whitespace-nowrap">
