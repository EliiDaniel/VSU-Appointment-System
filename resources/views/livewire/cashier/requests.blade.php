    ...
    <section>
        <div class="mx-auto" wire:poll.visble.5s>
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
                ...
                <div wire:ignore>
                    <x-dialog id="request-rejection" title="Request Rejection!" description="Rejection Notice, give reason for rejection" :show-reject-btn="true">
                        <x-textarea placeholder="This request is rejected due to..." wire:model="reason"/>
                    </x-dialog>
                </div>
