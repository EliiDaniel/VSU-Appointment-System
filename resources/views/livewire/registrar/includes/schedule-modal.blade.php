...
@if (session('status'))
    <div 
        ...
        role="alert"
    >
        @if(session('status') === "Appointment Settings")
            <span class="block sm:inline tracking-widest font-extrabold text-sm">Updated settings successfully.</span>
        @elseif(session('status') === "Blocked Date Created")
            <span class="block sm:inline tracking-widest font-extrabold text-sm">Blocked date created.</span>
        @endif
