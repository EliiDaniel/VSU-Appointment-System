<div>
    <div class="mx-auto mb-4">
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-4 flex">
            <div class="w-full grid grid-cols-5 gap-4 text-gray-900 dark:text-gray-100">
                <div class="col-span-4 space-y-4">
                    ...
                    <div class="grid grid-cols-4 gap-4 items-center">
                        <div class="col-span-2">
                            ...
                            <div class="flex flex-wrap md:text-md dark:text-gray-900 text-gray-100">
                                @foreach(json_decode($schedule->enabled_days) as $day)
                                <span class="bg-emerald-600 dark:bg-emerald-400 rounded-full mr-2 mb-2">
