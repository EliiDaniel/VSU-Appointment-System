        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div x-data="{ open: false }" class="flex">
                ...
                <div class="w-12 xl:w-64 mt-0" @mouseover="open = true" @mouseleave="open = false">
                    <header class="bg-white dark:bg-gray-800 shadow w-12 xl:w-64 hover:w-64 fixed top-[65px] z-[50] h-screen hover:px-8 py-6 xl:px-8 transition-all duration-75 ease-in-out overflow-hidden">
