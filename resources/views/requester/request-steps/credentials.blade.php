<div class="flex flex-col gap-2">
    ...
    <div wire:ignore x-init="
        ...
        <div class="flex gap-2 items-center">
            <x-input-label for="name" :value="__('Proof for approval')" />
            <button
                ...
                data-tooltip="Please upload images that serve as verification
                 of your eligibility to request documents from 
                 the university."
            >
                ?
            </button>
